    ...
    <div className="font-sans" dir="rtl">
      ...
      <section className="h-[40vh] relative flex items-center justify-center" style={{ backgroundImage: "url('/Skyline.jpeg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="text-center text-white z-10">
          <h1 className="text-5xl font-bold mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">דיני מקרקעין</h1>
          <p className="text-lg sm:text-xl lg:text-2xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">רכישת נכסים ועסקאות</p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-4 lg:space-y-6">
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                  דיני מקרקעין עוסקים בכל ההיבטים המשפטיים של נכסי דלא ניידי. אני מתמחה 
                  ברכישת נכסים, מכירת נכסים ועסקאות מקרקעין מורכבות.
                </p>
                
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                  המשרד שלי מספק שירותים מקיפים בתחום דיני המקרקעין, כולל ייעוץ משפטי, 
                  ניסוח חוזי מכר, בדיקת זכויות ופתרון סכסוכי מקרקעין.
                </p>
                
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                  עם ניסיון של למעלה מ-15 שנה, אני מכיר היטב את החקיקה והפסיקה 
                  בתחום דיני המקרקעין ומספק פתרונות מקצועיים ואפקטיביים.
                </p>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">רכישת נכסים ומכירת נכסים</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-gray-800 rounded-full"></div>
                    <span className="text-gray-700">ניסוח חוזי מכר</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-gray-800 rounded-full"></div>
                    <span className="text-gray-700">בדיקת זכויות במקרקעין</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-gray-800 rounded-full"></div>
                    <span className="text-gray-700">פתרון סכסוכי מקרקעין</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="w-full max-w-md lg:max-w-lg h-96 bg-gray-300 rounded-lg flex items-center justify-center shadow-lg">
                <span className="text-gray-600 text-lg">תמונה של דיני מקרקעין</span>
              </div>
            </div>
          </div>
        </div>
