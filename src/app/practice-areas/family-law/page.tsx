    ...
    <div className="font-sans" dir="rtl">
      ...
      <section className="h-[40vh] relative flex items-center justify-center" style={{ backgroundImage: "url('/Skyline.jpeg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="text-center text-white z-10">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">צוואות ויפוי כח מתמשך</h1>
...
<br></br>
מתן שירותים נוטריונים שונים; לרבות אימותי חתימה, אישורי צוואות, אישורי נכונות תרגום (ותרגום בסיוע חיצוני) אפוסטיל וכו&rsquo;.<br></br>
