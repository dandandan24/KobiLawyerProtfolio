    ...
    <div className="font-sans" dir="rtl">
      ...
      <section className="h-[30vh] relative bg-gradient-to-r from-gray-800 to-gray-700 flex items-center justify-center">
        <div className="text-center text-white z-10">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4">משפט מסחרי</h1>
          <p className="text-lg sm:text-xl lg:text-2xl">חברות ועסקים</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-6">מומחיות במשפט מסחרי</h2>
              
              <div className="space-y-4 lg:space-y-6">
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                  משפט מסחרי עוסק בכל ההיבטים המשפטיים של פעילות עסקית. אני מתמחה 
                  בייעוץ לחברות ועסקים במגוון רחב של נושאים מסחריים.
                </p>
                
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                  המשרד שלי מספק שירותים מקיפים בתחום המשפט המסחרי, כולל הקמת חברות, 
                  ניהול משפטי של עסקאות, ייעוץ רגולטורי ופתרון סכסוכים מסחריים.
                </p>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">הקמת חברות ועסקים</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-gray-800 rounded-full"></div>
                    <span className="text-gray-700">ניהול משפטי של עסקאות</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-gray-800 rounded-full"></div>
                    <span className="text-gray-700">ייעוץ רגולטורי</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-gray-800 rounded-full"></div>
                    <span className="text-gray-700">פתרון סכסוכים מסחריים</span>
                  </div>
                </div>
              </div>
            </div>
