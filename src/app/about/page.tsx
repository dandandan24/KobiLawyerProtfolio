...
export default function About() {
  return (
    <div className="font-sans" dir="rtl">
      ...
      <section className="h-[calc(100vh-60px)] bg-gray-50">
...
בתחום החוזים והמשפטי המסחרי המשרד מייצג חברות, יזמים ופרטיים בעריכת הסכמים מסחריים מסוגים שונים ובליווי תהליכים עסקיים מתקדמים.<br></br>
